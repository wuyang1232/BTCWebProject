...
func (a AddressInfo) QueryGetAddressInfoData() (*AddressInfo,error){
	row := mysql.DB.QueryRow("select address,script_pubkey,is_mine,solvable,desc,is_watch_only,is_script,is_witness,witness_version,witness_program,pubkey,is_change,time_stamp,hdkey_path,hd_seedid,hd_master_finger_print,lables from getaddressinfo where address = ?",
		a.Address)
